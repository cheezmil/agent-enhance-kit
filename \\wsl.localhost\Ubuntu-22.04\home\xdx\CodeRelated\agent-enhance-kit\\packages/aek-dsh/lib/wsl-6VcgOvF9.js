...
async function listDistros(wslPath = "wsl.exe") {
	let stdout;
	try {
		const result = await execFileAsync(wslPath, ["-l", "-q"], {
			encoding: "buffer",
...
//#endregion
export { canonicalWindowsPath, defaultDistro, defaultDistroSync, isAbsoluteLinuxPath, isValidWslUsername, isWindowsPathShaped, joinUnc, listDistros, mntToWindowsPath, normalizeLinuxPath, parseWslUnc, windowsToMntPath };
//# sourceMappingURL=wsl-6VcgOvF9.js.map