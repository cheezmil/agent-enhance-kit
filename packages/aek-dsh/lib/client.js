window.__ModuleLoader__.load({ id: "aek-dsh", factory: (require) => {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
					...
					href: "https://www.npmjs.com/package/aek-dsh",
					target: "_blank",
					rel: "noreferrer",
					children: t("help.footer.npm")
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
					className: "dww-help-link",
					href: "https://github.com/6Mikao9/aek-dsh",
					target: "_blank",
					rel: "noreferrer",
...
*/
const STYLE_TAG_DATA_ATTRIBUTE = "data-plugin=\"aek-dsh\"";
const STYLES = `
...
function ensureStyles() {
	...
	style.setAttribute("data-plugin", "aek-dsh");
...
function apply(ctx) {
	...
	*/
	...
	ctx.effect(() => ctx.slots.inject("sidebar.footer.action", () => ctx.slots.register({
		...
		id: "wsl-workspace",
		inject: injected
	}, AddWslWorkspace)), "aek-dsh: sidebar footer action");
	ctx.effect(() => {
