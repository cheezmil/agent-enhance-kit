import { defaultDistroSync, isValidWslUsername, isWindowsPathShaped, joinUnc, parseWslUnc, windowsToMntPath } from "./wsl-6VcgOvF9.js";
import { getWorkspaceUsername } from "./wsl-credentials-B6wIXsKt.js";
...
var WslShellExecutor = class WslShellExecutor extends ShellExecutor {
	...
	*/
	withWslEnv(spec) {
		...
		const merged = [ambient, flags.join(":")].filter((part) => part !== void 0 && part !== "").join(":");
		env.WSLENV = merged;
		return env;
	}
...
var shell_default = WslShellExecutor;

//#endregion
export { WslShellExecutor, assertServiceableWslConfig, shell_default as default };
