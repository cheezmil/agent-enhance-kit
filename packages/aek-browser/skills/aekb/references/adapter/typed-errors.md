...
```js
import { ArgumentError } from '@cheezmil/aek-b/errors';
...
```js
import { EmptyResultError, CommandExecutionError } from '@cheezmil/aek-b/errors';
...
新写 fixture 时（`~/.aek-b/sites/<site>/verify/<cmd>.json`）：
