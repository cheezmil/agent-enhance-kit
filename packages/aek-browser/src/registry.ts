...
declare global { var __aekb_registry__: Map<string, CliCommand> | undefined; }
const _registry: Map<string, CliCommand> =
  globalThis.__aekb_registry__ ??= new Map<string, CliCommand>();
 ...
 *
 * `strategy` itself is preserved as metadata for `aekb list`, cascade
