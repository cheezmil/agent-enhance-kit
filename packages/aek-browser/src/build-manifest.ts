 ...
 *   - `aekb twitter followers --help` rendered `Arguments:\n  user  ` with
...
async function main(): Promise<void> {
  ...
  if (metadataIssues.length > 0) {
    ...
    process.stderr.write(
      ...
      + `\`aekb <site> <cmd> --help\` shows callers what the parameter is for.\n`
  ...
  // See: https://github.com/cheezmil/aek-browser/issues/446
