      ...
      - listitem [ref=e89]:
        - generic [ref=e90]:
          - link "Repository" [ref=e91] [cursor=pointer]:
            - /url: /cheezmil/twitter-cli
            - img "Repository" [ref=e92]
          - link "cheezmil/twitter-cli" [ref=e94] [cursor=pointer]:
            - /url: /cheezmil/twitter-cli
      - listitem [ref=e95]:
        - generic [ref=e96]:
          ...
          - link "cheezmil/aekb" [ref=e100] [cursor=pointer]:
            - /url: /cheezmil/aekb`;
...
- main [ref=e1]:
  ...
  describe('GitHub snapshot', () => {
    ...
    it('preserves repo list structure', () => {
      ...
      expect(result).toContain('link "cheezmil/twitter-cli"');
      expect(result).toContain('link "cheezmil/aekb"');
