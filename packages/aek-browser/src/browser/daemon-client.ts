/**
 * HTTP client for communicating with the AEK Browser daemon.
 *
...
export interface DaemonCommand {
  ...
  frameIndex?: number;
  /** Browser profile/context REQUIRED for this command (--profile / AEKB_PROFILE). Fails loud when offline. */
  contextId?: string;
  /**
...
async function sendCommandRaw(
  ...
  const rawWindowMode = process.env.AEKB_WINDOW;
