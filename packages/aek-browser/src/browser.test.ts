...
describe('browser helpers', () => {
  ...
  it('honors AEKB_CDP_TARGET when multiple inspectable targets exist', () => {
    vi.stubEnv('AEKB_CDP_TARGET', 'codex');
  ...
  it('honors AEKB_CDP_TARGET even when it names a routed auxiliary window', () => {
    vi.stubEnv('AEKB_CDP_TARGET', 'avatar-overlay');
