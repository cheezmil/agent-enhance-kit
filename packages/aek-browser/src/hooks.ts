/**
 * Plugin lifecycle hooks: allows plugins to tap into aekb's execution lifecycle.
 *
...
declare global {
  ...
  var __aekb_hooks__: Map<HookName, HookFn[]> | undefined;
}
const _hooks: Map<HookName, HookFn[]> =
  globalThis.__aekb_hooks__ ??= new Map();
...
// ── Emit API (used internally by aekb core) ─────────────────────────────
