 ...
 *
 * Ensures adapter files use @cheezmil/aek-browser/... package imports
...
function isAllowedImport(specifier: string): boolean {
  return specifier.startsWith('./')
    ...
    || specifier.startsWith('/')
    || specifier.startsWith('@cheezmil/aek-browser/')
...
describe('adapter imports use package exports', () => {
  ...
  it('non-test adapters only import node builtins, relative modules, or aekb public APIs', () => {
