...
- read front page → 直接用 adapter `aek-browser hackernews top`，无需 workflow
- read newest / best / show / ask / jobs → adapter `aek-browser hackernews <feed>`，无需 workflow
- read single story + comments → adapter `aek-browser hackernews story <id>`，无需 workflow
- search → adapter `aek-browser hackernews search`，无需 workflow
- read user profile → adapter `aek-browser hackernews user <handle>`，无需 workflow
