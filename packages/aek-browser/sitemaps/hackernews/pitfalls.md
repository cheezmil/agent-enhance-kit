...
- workaround: 链 `/item/<id>.json` 一一拿；用 adapter `aek-browser hackernews top` 已封装这个 fan-out
...
- workaround: 用 Algolia HN search endpoint（apis.md `algolia_search`）或 adapter `aek-browser hackernews search`
- verified_at: 2026-06-02
