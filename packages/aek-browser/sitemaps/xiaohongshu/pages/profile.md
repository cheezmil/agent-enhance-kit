...
do: aek-browser xiaohongshu user <id>
...
recover: AuthRequired -> aek-browser xiaohongshu login（# pending: codex task #276）；CommandExecution -> adapter_health suspect；Empty 视为合法
evidence: aek-browser xiaohongshu user
```
