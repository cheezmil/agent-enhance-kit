...
adapter: `aek-browser gmail search <query>`; use inbox/unread/starred/sent/drafts/trash/spam/snoozed/important shortcuts when applicable
...
on_adapter_fail:
1. `adapter_health_update: aek-browser gmail search -> suspect`
