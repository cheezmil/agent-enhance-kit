...
adapter: `aek-browser gmail thread <thread>`; use `aek-browser gmail attachments <thread>` for attachment rows
...
on_adapter_fail:
1. `adapter_health_update: aek-browser gmail thread -> suspect`
