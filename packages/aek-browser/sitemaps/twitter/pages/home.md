...
do: aek-browser twitter post --text "..." || click [data-testid="tweetButtonInline"]
...
recover: adapter_health_update: aek-browser twitter post -> suspect; check text length / login; or workflows/post.md Fallback
...
evidence: aek-browser browser evaluate
```
