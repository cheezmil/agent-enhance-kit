/**
 * aek-browser browser protocol — shared types between daemon, extension, and CLI.
 *
...
/** Storage key for custom daemon host (overrides DAEMON_HOST) */
export const DAEMON_HOST_KEY = 'aek-browser_daemon_host';
