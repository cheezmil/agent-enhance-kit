    ...
    if (raw && !username) {
        throw new ArgumentError(
            ...
            commandName === 'collection'
                ? 'Example: AEK Browser twitter collection @jack --until 2026-07-23T00:00:00Z'
                : 'Example: AEK Browser twitter tweets @jack --limit 20',
        );
    }
    if (!username && !allowLoggedInDefault) {
        throw new ArgumentError('twitter collection username must be a valid Twitter/X handle', 'Example: AEK Browser twitter collection @jack --until 2026-07-23T00:00:00Z');
    }
    if (!username) {
