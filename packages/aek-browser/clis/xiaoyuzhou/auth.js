...
import { CliError, CommandExecutionError, ConfigError, EXIT_CODES, getErrorMessage } from '@cheezmil/aek-browser/errors';
...
export function getXiaoyuzhouCredentialFile() {
    return path.join(os.homedir(), '.aek/browser/system', 'xiaoyuzhou.json');
}
