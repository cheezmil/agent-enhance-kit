...
import { ArgumentError, CliError } from '@cheezmil/aek-browser/errors';
...
cli({
    ...
    func: async (kwargs) => {
        if (kwargs.json === false && kwargs.text === false) {
            throw new ArgumentError('At least one of --json or --text must be enabled', 'Example: AEK Browser xiaoyuzhou transcript 69dd0c98e2c8be31551f6a33 --text true');
        }
