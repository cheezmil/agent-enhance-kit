...
export function parseTarget(input) {
    ...
    if (value.startsWith('answer:') && !ANSWER_RE.test(value)) {
        throw new CliError('INVALID_INPUT', 'Invalid answer target, expected answer:<questionId>:<answerId>', 'Example: AEK Browser zhihu like answer:123:456 --execute');
    }
    ...
    throw new CliError('INVALID_INPUT', 'Zhihu write commands require a Zhihu URL or typed target like question:123 or answer:123:456', 'Example: AEK Browser zhihu like answer:123:456 --execute');
}
