...
function createTempFile(name, bytes) {
    const dir = fs.mkdtempSync(path.join(os.tmpdir(), 'aekb-instagram-private-'));
    tempDirs.push(dir);
...
describe('instagram private publish helpers', () => {
    ...
    it('resolves private publish config from capture, runtime html, and cookies', async () => {
        ...
        try {
            ...
            expect(page.goto).toHaveBeenNthCalledWith(1, 'https://www.instagram.com/?__aekb_private_probe=1700000000000');
