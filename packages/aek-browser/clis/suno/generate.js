/**
 * `aekb suno generate` — submit a Suno music-generation request, wait for
    ...
    func: async (page, kwargs) => {
        ...
        if (!isCustom && !description.trim()) {
            throw new ArgumentError(
                ...
                'Examples:\n  AEK Browser suno generate "lo-fi study beat, 80 bpm"\n  AEK Browser suno generate --lyrics "[Verse]\\n..." --tags "synthwave, 120 bpm"',
            );
        }
