 ...
 * succeeds from a real Chrome tab, but the AEK Browser bridge's evaluate
...
import { ArgumentError, AuthRequiredError, CommandExecutionError, EmptyResultError, TimeoutError } from '@cheezmil/aek-browser/errors';
