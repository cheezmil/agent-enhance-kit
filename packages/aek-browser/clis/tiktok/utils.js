...
//
// - Node-side: input validation (typed errors per AEK Browser rules).
...
export function normalizeUsername(value) {
    ...
    if (!username) {
        throw new ArgumentError(
            ...
            'Example: AEK Browser tiktok following <username>',
        );
    }
...
export function requireCommentText(value) {
    ...
    if (!text) {
        throw new ArgumentError(
            ...
            'Example: AEK Browser tiktok comment <url> "great video"',
        );
    }
...
export function parseTikTokVideoUrl(value) {
    ...
    if (!raw) {
        throw new ArgumentError(
            ...
            'Example: AEK Browser tiktok comment https://www.tiktok.com/@user/video/1234567890 "..."',
        );
    }
    let parsed;
    try {
