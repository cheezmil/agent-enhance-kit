...
const GEMINI_COMPOSER_MARKER_ATTR = 'data-aekb-gemini-composer';
...
function exportGeminiDeepResearchReportScript(maxWaitMs) {
    ...
    (async () => {
      ...
      const recorderKey = '__aekbGeminiExportUrls';
      const patchedKey = '__aekbGeminiExportPatched';
      const trace = [];
      ...
      const ensureRecorder = () => {
        ...
        XMLHttpRequest.prototype.open = function(method, url, ...rest) {
          ...
          try { this.__aekbReqUrl = String(url || ''); } catch {}
          ...
          try {
            this.addEventListener('load', () => {
              try {
                ...
                const reqUrl = String(this.__aekbReqUrl || '');
                if (isDriveDocCreateRequest(reqUrl)) {
