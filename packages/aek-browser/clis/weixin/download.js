 ...
 *
 * Ported from cheezmil/wechat-article-to-markdown (JS version) to AEK Browser adapter.
 *
 * Usage:
 *   AEK Browser weixin download --url "https://mp.weixin.qq.com/s/xxx" --output ./weixin
 */
