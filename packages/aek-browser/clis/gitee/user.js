...
cli({
    ...
    func: async (page, args) => {
        ...
        if (!username) {
            throw new CliError('INVALID_ARGUMENT', 'Username is required', 'Use: AEK Browser gitee user <username>');
        }
    ...
    `);
        ...
        if (domSnapshot.notFound) {
            throw new CliError('NOT_FOUND', `Gitee user "${username}" does not exist`, 'Check the username and retry: AEK Browser gitee user <username>');
        }
