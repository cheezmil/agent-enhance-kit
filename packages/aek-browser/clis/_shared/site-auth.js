import { AuthRequiredError, TimeoutError, getErrorMessage } from '@cheezmil/aek-browser/errors';
...
function authHint(config) {
  return `Run \`aekb ${config.site} login\` to open the login page, then retry.`;
}
