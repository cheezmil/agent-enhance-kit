...
describe('google images', () => {
    ...
    it('rejects empty query and invalid limits before navigation', async () => {
        ...
        await expect(command.func(page, { keyword: 'aekb', limit: 0 })).rejects.toMatchObject({ code: 'ARGUMENT' });
        await expect(command.func(page, { keyword: 'aekb', limit: 101 })).rejects.toMatchObject({ code: 'ARGUMENT' });
