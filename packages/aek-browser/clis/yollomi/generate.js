...
cli({
    ...
    args: [
        ...
        { name: 'image', help: 'Input image URL for image-to-image (upload via "AEK Browser yollomi upload" first)' },
    ...
    func: async (page, kwargs) => {
        ...
        if (!apiPath)
            throw new CliError('INVALID_MODEL', `Unknown model: ${modelId}`, 'Run "AEK Browser yollomi models --type image" to see available models');
        let body;
