import { AuthRequiredError, TimeoutError } from '@cheezmil/aek-browser/errors';
...
cli({
  ...
  example: 'AEK Browser midjourney login --timeout 300',
  ...
  func: async (page, kwargs) => {
    ...
    throw new TimeoutError(
      ...
      'Finish signing in in the foreground Chrome window, then retry `aekb midjourney whoami`.',
    );
  },
});
