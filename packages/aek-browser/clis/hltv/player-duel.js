...
import { ArgumentError, EmptyResultError } from '@cheezmil/aek-browser/errors';
import {
  normalizeLimit,
  normalizeOffset,
  parsePlayerRef,
...
cli({
  ...
  access: 'read',
  example: 'AEK Browser hltv player-duel 19230/m0nesy 3741/niko --match https://www.hltv.org/stats/matches/mapstatsid/231594/falcons-vs-natus-vincere -f json',
  domain: 'www.hltv.org',
