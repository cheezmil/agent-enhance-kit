...
import { AuthRequiredError, EmptyResultError } from '@cheezmil/aek-browser/errors';
...
cli({
    ...
    func: async (page) => {
        ...
        if (rpcError)
            throw rpcError;
        throw new EmptyResultError('AEK Browser notebooklm list', 'No NotebookLM notebooks were found after the authenticated RPC and home-page fallback both returned empty.');
    },
});
