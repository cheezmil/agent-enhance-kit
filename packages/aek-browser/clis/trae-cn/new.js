...
import { CommandExecutionError, selectorError } from '@cheezmil/aek-browser/errors';
...
export const newCommand = cli({
  ...
  example: 'AEKB_CDP_ENDPOINT=http://127.0.0.1:39240 AEKB_CDP_TARGET=talk AEK Browser trae-cn new "请执行你的任务" -f json',
  domain: 'localhost',
