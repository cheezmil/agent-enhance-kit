...
export const setupCommand = cli({
  ...
  name: 'setup',
  access: 'read',
  description: 'Show local setup commands for controlling Trae CN with AEK Browser',
  example: 'AEK Browser trae-cn setup -f table',
  ...
  func: async () => [
    ...
    {
      Step: '2. Point AEK Browser at Trae',
      Command: 'export AEKB_CDP_ENDPOINT="http://127.0.0.1:39240"',
      Purpose: 'Tell AEK Browser which local Trae CDP endpoint to use',
    },
    {
      Step: '3. Select a workspace target',
      Command: 'export AEKB_CDP_TARGET="talk"',
      Purpose: 'Choose the Trae workspace/window title when multiple targets are open',
    },
    {
      Step: '4. List Trae targets',
      Command: 'AEK Browser trae-cn targets -f table',
      Purpose: 'Find the right workspace target and spot windows with ApprovalPending=yes',
    },
    {
      Step: '5. Verify connection',
      Command: 'AEK Browser trae-cn status -f json',
      Purpose: 'Confirm workspace, model, agent, turn count, and composer readiness',
    },
    {
      Step: '6. Start a fresh task',
      Command: 'AEK Browser trae-cn new "请执行你的任务" -f json',
      Purpose: 'Create a new task and send the first prompt',
    },
    {
      Step: '7. Monitor progress',
      Command: 'AEK Browser trae-cn watch --stream true --duration 120',
    ...
    },
    {
      ...
      Purpose: 'Trae CN may still stop these as high-risk even when command mode is 自动运行; AEK Browser approves them only after explicit --auto-approve true or approve',
    },
    {
      Step: 'Help',
      Command: 'AEK Browser trae-cn --help -f yaml',
