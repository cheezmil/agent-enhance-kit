...
## 禁止用CLI命令修改hermes配置，请务必直接修改它的yaml配置文件。修改配置文件必须直接修改“D:\CodeRelated\cheezmil-task-manager\agent_start\hermes\hermes_config.yaml”，然后执行“D:\CodeRelated\cheezmil-task-manager\agent_start\hermes\apply_hermes_config.py”使配置文件生效。
